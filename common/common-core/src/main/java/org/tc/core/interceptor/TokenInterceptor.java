package org.tc.core.interceptor;

import org.tc.annotation.NoNeedAccessAuthentication;
...
public class TokenInterceptor implements HandlerInterceptor {
    ...
    @Value("${mallcloud.oauth2.jwtSigningKey}")
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response,
                                Object arg2, Exception ex) throws Exception {
        if (ex != null) {
