...
public class RedisKeyUtil {
     ...
     */
    private static final String RESET_PWD_TOKEN_KEY = "mallcloud:restPwd";
    private static final String ACTIVE_USER = "mallcloud:activeUser";
    private static final String SEND_SMS_COUNT = "mallcloud:sms:count";
    private static final String SEND_EMAIL_CODE = "mallcloud:email:code";
    private static final String ACCESS_TOKEN = "mallcloud:token:accessToken";
    private static final String UPLOAD_FILE_SIZE = "mallcloud:file:upload_file_size";
