...
import org.tc.provider.validate.code.*;
...
public abstract class AbstractValidateCodeProcessor<C extends ValidateCode>
    ...
    private void saveValidateCode(ServletWebRequest request, C validateCode) {
        ...
        validateCodeRepository.saveToRedis(request, code, getValidateCodeType());
    }
    ...
    public void check(ServletWebRequest request) {
        ...
        try {
            ...
            String type = codeType.getParamNameOnValidate();
            codeInRequest = ServletRequestUtils.getStringParameter(req, type);
